...
public class DbUpdateReducer extends
  ...
  protected void setup(Context context) throws IOException,
    ...
    System.out.println("DbUpdateReduce setup...");
  ...
  protected void reduce(UrlWithScore key, Iterable<NutchWritable> values,
    ...
    System.out.println("DbUpdateReduce reduce  ");
    ...
    //if (parse_mark != null) {
      Mark.UPDATEDB_MARK.putMark(page, new Utf8("y")/*parse_mark*/);
      Mark.PARSE_MARK.removeMark(page);
    //}

    System.out.println("DbUpdateReduce updatedb_mark:"+Mark.UPDATEDB_MARK.checkMark(page));
