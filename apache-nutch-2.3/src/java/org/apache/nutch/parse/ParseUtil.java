...
public class ParseUtil extends Configured {
  ...
  public void process(String key, WebPage page) {
    ...
    System.out.println("page.getStatus().byteValue() "+status+" CrawlStatus.STATUS_FETCHED "+CrawlStatus.STATUS_FETCHED);
    ...
    LOG.info("parse.getParseStatus() "+pstatus);
